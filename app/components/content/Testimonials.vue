...
const testimonials = [
    ...
    {
        name: 'คุณวิภาดา',
        position: 'เจ้าของธุรกิจร้านอาหาร',
    ...
    {
        name: 'คุณสิริมา',
        position: 'ร้านค้าออนไลน์',
        quote: 'เปลี่ยนมาใช้บริการที่นี่แล้วสบายใจเรื่องบัญชีร้านค้าออนไลน์มากค่ะ ทีมงานมีความรู้เรื่องภาษีออนไลน์โดยเฉพาะ แนะนำดีมากค่ะ',
